...
module1 = Extension('gcophrotor',
          ...
          libraries = ['gcop_systems','gcop_algos','gcop_est','gcop_utils','gcop_views',
                       'glut','GLU','tinyxml','ceres','glog','casadi',
                       #'g2o_incremental','g2o_solver_cholmod',
                       'gflags',
                       #'cxsparse',
                       'tbbmalloc','tbb',
                       #'cholmod','ccolamd','camd','colamd','amd',
                       'lapack','blas', 
                       #'suitesparseconfig', 
                       'rt',
                       #'cxsparse', 
