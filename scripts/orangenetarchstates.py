...
class OrangeNet8(torch.nn.Module):
    def __init__(self, capacity = 1, num_img = 1, num_pts = 3, bins = 30, mins = None, maxs = None, n_outputs = 3, real_test = False, retrain_off = "", input = 1.0, num_channels = 3, real=True, state_count=0):
        ...
        self.fc3 = nn.Linear(int(8192*self.f),int(4096*self.f)) #TODO: maybe add a separate fc layer for each
        ...
        self.output = nn.Linear(int(4096*self.f),n_outputs*self.num_points*self.bins)
